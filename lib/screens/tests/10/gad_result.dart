...
class GADResult extends StatelessWidget {
  const GADResult({super.key, required this.resultModel});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('General Anxiety Disorder'),
        centerTitle: true,
      ),
      body: Padding(
