...
class LoveObsessionResult extends StatelessWidget {
  const LoveObsessionResult({super.key, required this.resultModel});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Love Obsession'),
        centerTitle: true,
      ),
      body: Padding(
