...
const Color kGreenColor = Color(0xffD3EFD8);
const Color kPurpleColor = Color(0xffddc3f6);
const Color kYellowColor = Color(0xffFFF5C0);
const Color kBlueColor = Color(0x7e8cb0ff);
